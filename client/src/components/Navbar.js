    ...
    if (user) {
      return (
        <Menu.Menu position='right'>
          ...
          <div style={this.state.moble ? {marginRight:"0px", marginTop:"10px"} : {marginRight:"100px", marginTop:"10px"}}>
      ...
      return(
        <Menu.Menu position='right'>
        <Dropdown icon={<img alt='logo' width="32" height="32" style={this.state.moble ? {marginRight:"0px", marginTop:"10px", borderRadius:"50px"} : {marginRight:"100px", marginTop:"10px", borderRadius:"50px"}} src='https://imgur.com/HTsTTzg.png'/>}>
        <Dropdown.Menu style={this.state.moble ? {marginRight:"0px",} : {marginRight:"75px",}}>
    ...
    return (
      <div>
        <Menu pointing secondary>
          <Link to='/'>
          <Image src='https://imgur.com/ID0zLWh.png' size='small' style={this.state.moble ? {marginLeft: "0px"} : {marginLeft: "70%"}} />
          </Link>
            { this.rightNavItems() }
        </Menu>
        {this.Form()}
