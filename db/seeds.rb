...
10.times do
  ...
  v = Video.create(title: Faker::Book.title, duration: rand() + rand(5) , genre: Faker::Book.genre, description: Faker::Lorem.sentences(3), trailer: "https://www.youtube.com/embed/" + parsed["vid"], user_id: u.id)
  10.times do
